...
describe("MarketPlace Proxy Contract Deployment", function() {
  it("Should deploy the ERC20token, ERC721token, marketplace, collections, Market Mint, offers, bids, trades contract and connect them together.", async function() {
    before((done) => {
    ...
    const token = await PHAMToken.deploy(ownerProxyAddress, marketMintAddress);
    ...
    const nft = await NFT.deploy(ownerProxyAddress, marketMintAddress,"PhamNFTs", "PHAMNFT");
    await nft.deployed()
    const nftContractAddress = nft.address;
    console.log("ERC721 NFT Contract Address: "+ nftContractAddress)

    const NFT1155 = await ethers.getContractFactory("Pham1155");
    const nft1155 = await NFT1155.deploy('0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266', '0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266',"https://ipfs.io/ipfs/");
    await nft1155.deployed()
    const nft1155ContractAddress = nft1155.address;
    console.log("ERC1155 NFT Contract Address: "+ nft1155ContractAddress)

    const MarketBids = await ethers.getContractFactory("MarketBids");
    const marketBids = await MarketBids.deploy(roleProviderAddress, marketAddress, marketMintAddress);
    ...
    const marketOffers = await MarketOffers.deploy(roleProviderAddress, marketAddress, marketMintAddress);
    ...
    const marketTrades = await MarketTrades.deploy(roleProviderAddress, marketAddress, marketMintAddress);
    ...
    const nftFactory = await NFTFactory.deploy(roleProviderAddress)
    await nftFactory.deployed();
    const nftFactoryAddress = nftFactory.address;
    console.log("ERC 721 NFT Factory address is: ",nftFactoryAddress);

    const NFT1155Factory = await ethers.getContractFactory("ERC1155Factory");
    const nft1155Factory = await NFT1155Factory.deploy(roleProviderAddress);
    await nft1155Factory.deployed();
    const nft1155FactoryAddress = nft1155Factory.address;
    console.log("ERC 1155 NFT Factory address is: ",nft1155FactoryAddress);

    const RewardsCotroller = await ethers.getContractFactory("RewardsControl");
    const rewardsController = await RewardsCotroller.deploy(roleProviderAddress, "0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266")
    ...
    // Initializing all the addresses in the OwnerProxy 
    await ownerProxy.addressInit(marketAddress, nftContractAddress, marketMintAddress, marketCollectionsAddress, marketOffersAddress, marketTradesAddress, marketBidsAddress, rewardsControllerAddress,nftFactoryAddress,nft1155FactoryAddress);
    console.log("Initialized all the contract addresses to the Owner Proxy contract.")
    // It should set the Market Mint and nft addresses for the Controller contract
    
    // Granting PROXY and CONTRACT roles to contract to interact through OwnerProxy contract
    await ownerProxy.setProxyRoles(["0x77d72916e966418e6dc58a19999ae9934bef3f749f1547cde0a86e809f19c89b","0x77d72916e966418e6dc58a19999ae9934bef3f749f1547cde0a86e809f19c89b","0x77d72916e966418e6dc58a19999ae9934bef3f749f1547cde0a86e809f19c89b","0x77d72916e966418e6dc58a19999ae9934bef3f749f1547cde0a86e809f19c89b","0x77d72916e966418e6dc58a19999ae9934bef3f749f1547cde0a86e809f19c89b","0x77d72916e966418e6dc58a19999ae9934bef3f749f1547cde0a86e809f19c89b","0x77d72916e966418e6dc58a19999ae9934bef3f749f1547cde0a86e809f19c89b","0x77d72916e966418e6dc58a19999ae9934bef3f749f1547cde0a86e809f19c89b","0x77d72916e966418e6dc58a19999ae9934bef3f749f1547cde0a86e809f19c89b","0x77d72916e966418e6dc58a19999ae9934bef3f749f1547cde0a86e809f19c89b","0x77d72916e966418e6dc58a19999ae9934bef3f749f1547cde0a86e809f19c89b"],
